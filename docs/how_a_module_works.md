...
- **The Module 5 written assignment (one explanation per module):** [`module5_assignment.md`](module5_assignment.md). Do it right after each module — the written companion to Defend-It.
